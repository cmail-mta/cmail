<?php
	...
	class User implements Module {
		...
		public function getAll() {
			...
			$sql = "SELECT user_name, user_authdata IS NOT NULL AS has_login, user_alias, user_database, link_count FROM users LEFT JOIN (SELECT address_route, count(address_route) AS link_count FROM addresses WHERE address_router = 'store' GROUP BY address_route) ON (address_route = user_name)";
